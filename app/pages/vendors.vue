    ...
    <UContainer>
      ...
      >
        ...
        <img
          ...
          alt="The Hampton Berkley founders standing together in their studio"
          width="2832"
          height="4240"
          loading="eager"
          class="mx-auto aspect-square w-full max-w-md rounded-xl object-cover object-center shadow-sm"
        />
      </section>
